                                                    ...
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            <a href="{{ url('single-product/'.$product->id.'/'.$product->name ) }}">
                                                                <img src="{{ asset('uploads/products/images/'.$product->image)}}" alt="Li's Product Image">
                                                            </a>
                                                            ...
                                                            <div class="product_desc_info">
                                                                <div class="product-review">
                                                                    <h5 class="manufacturer">
                                                                        <a href="{{ url('category/'.$product->cat_id.'/'.$product->categorys->name ) }}">Home{{ $product->categorys->name }}</a>
                                                                    </h5>
